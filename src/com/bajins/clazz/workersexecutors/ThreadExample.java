 ...
 * @see Thread
 * @see Runnable
 * @see CountDownLatch 计数器：等待多个线程完成
 * @see CyclicBarrier 循环栅栏：一个可循环利用的屏障，在某个点让所有线程都等待完成后才会继续下一步行动 https://www.jianshu.com/p/043ac5689002
 * @see Phaser 线程屏障同步器，动态分段锁
